#!/usr/bin/env python3
"""
Copy Fluent UI System Icons font files (TTF and HTML) to target directory.
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Copy Fluent UI System Icons TTF and HTML files to target directory"
    )
    parser.add_argument(
        "--output-dir",
        "-o",
        default="assets/ttf",
        help="Output directory (default: assets/ttf)",
    )
